...
},{}],25:[optionEnglish,{}],26:[function(_dereq_,module,exports){
module.exports={
    "meta": {
        "capitalizeFirstLetter": true
    },
	...
	module.exports = L.Class.extend({
		...
		_setResults: function(results) {
			...
			for (i = 0; i < results.length; i++) {
                ...
                if(results[i].properties.text != null){
                    $name = results[i].properties.text;
                }
				// text = document.createTextNode($name);
				// td.appendChild(text);
				td.innerHTML = '<span class="panel-list-item-icon icon-local-gps"></span>' + $name;
...
(function() {
    ...
    options2.routeLine = function(route, options) { return new Line(route, options); },
	...
	module.exports = L.Class.extend({
		...
		options: {
            ...
            waypointNameFallback: function(latLng) {
                var ns = latLng.lat < 0 ?  options5.s :  options5.n,
                    ew = latLng.lng < 0 ?  options5.w :  options5.e,
...
(function() {
	...
	options6.collapseBtn = function(itinerary) {
	...
	module.exports = L.Control.extend({
		...
		onAdd: function(map) {
			...
			var $router_expander = L.DomUtil.create('span', 'router-expander');
			var $router_expander_inverse = L.DomUtil.create('span', 'router-expander-inverse');
            $router_expander.innerHTML += '<a onclick="hideRouteControl();return false;"><span class="panel-list-item-icon icon-local-top"></span></a>';
            $router_expander_inverse.innerHTML += '<a onclick="showRouteControl();return false;"><span class="panel-list-item-icon icon-local-bottom"></span></a>';
            this._container.appendChild($router_expander);
            this._container.appendChild($router_expander_inverse);
