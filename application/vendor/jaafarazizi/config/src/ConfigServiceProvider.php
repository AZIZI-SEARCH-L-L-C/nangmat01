...
class ConfigServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('JaafarAzizi\Config\Repository', function($app, $items)
        {
        ...
        {
            return $app->make('JaafarAzizi\Config\Repository', $config_items);
        });
    }
}
